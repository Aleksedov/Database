...
def article_analys(url, curs, session):
    """
    ...
    :return:
    """
    type_url = url + 'articles/api/'                          # сcылка на API - список объектов # отличие 1
    ...
    print(objs_json)
    db_objs = Tables("Статті", curs)                         # отличие 2
    print(db_objs)
