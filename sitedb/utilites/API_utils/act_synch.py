...
def act_analys(url, curs, session):
    """
    ...
    :return:
    """
    type_url = url + 'acts_api/'                          # сcылка на API - список объектов # отличие 1
        ...
        for i_site in objs_json.items:
            ...
            if i_site not in db_objs.items:
                ...
                pare_keys = {
                    ...
                    "type_of_act": "Тіп порушення",
                    "сase_num": "№ справи в суді",
                    "сase_decision": "Судове рішення",
                    "sentence": "Тип вироку",
                    "year_sentence": "Років",
                    "month_sentence": "Місяців",
                    "day_sentence": "Діб",
                    "penalty_sentence": "Штраф",
                    "work_sentence": "Примусови роботи",
                    "overview": "Примітки",
                    "appeal": "Апелляція"
                }
                ...
                if discr:
                    ...
                    for key, value in discr.items():
                        pt[key] = value
                    try:
                        session.put(obj_request, json=pt)
                    except:
                        print("onnectionError(err, request=request)",pt, obj_request)
